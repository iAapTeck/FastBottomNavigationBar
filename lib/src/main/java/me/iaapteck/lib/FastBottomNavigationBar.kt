...
import me.iaapteck.lib.ext.d2p

class FastBottomNavigationBar @JvmOverloads constructor(
    context: Context,
     ...
     *
     * Just call [FastBottomNavigationBar.setOnItemSelectedListener] to override [onItemSelectedListener]
     *
     * @sample
     ...
     * Created by Vladislav Perevedentsev on 29.07.2020.
     *
     * Just call [FastBottomNavigationBar.setOnItemReselectedListener] to override [onItemReselectedListener]
     *
     * @sample
